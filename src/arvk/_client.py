...
from ._exceptions import ArvkError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Arvk", "AsyncArvk", "Client", "AsyncClient"]


class Arvk(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Arvk client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("ARVK_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("ARVK_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> ArvkWithRawResponse:
        return ArvkWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ArvkWithStreamedResponse:
        return ArvkWithStreamedResponse(self)
...
class AsyncArvk(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncArvk client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncArvkWithRawResponse:
        return AsyncArvkWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncArvkWithStreamedResponse:
        return AsyncArvkWithStreamedResponse(self)
...
class ArvkWithRawResponse:
    _client: Arvk

    def __init__(self, client: Arvk) -> None:
        self._client = client
...
class AsyncArvkWithRawResponse:
    _client: AsyncArvk

    def __init__(self, client: AsyncArvk) -> None:
        self._client = client
...
class ArvkWithStreamedResponse:
    _client: Arvk
...
class AsyncArvkWithStreamedResponse:
    _client: AsyncArvk
